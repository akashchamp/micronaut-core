...
/**
 * A flow that is created on first use, depending on the subscriber. Used as an
 * {@link ExecutionFlow} it is created without any reactive code. Converted to a publisher
 * ({@link ReactiveExecutionFlow#fromFlow}, {@link ReactiveExecutionFlow#toPublisher}) it is
 * created on subscription as a reactive flow, so it can keep the Reactor context of the subscriber.
 *
